...
@objc public protocol HSSStyleSheet: HSSColors, HSSFonts {}
@objc public protocol HSSColors: HSSPrimaryColors, HSSSecondaryColors {}
/**
  AndesColors is used to create a new StyleSheet
  implementing all the necessary colors
*/
@objc public protocol HSSPrimaryColors {
...
public extension HSSPrimaryColors {
...
@objc public protocol HSSSecondaryColors {
