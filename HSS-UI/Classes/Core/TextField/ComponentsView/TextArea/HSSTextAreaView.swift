...
class HSSTextAreaView: HSSTextFieldAbstractView {
    @IBOutlet weak var textView: HSSUITextView!
    ...
    override func loadNib() {
        ...
        bundle.loadNibNamed("HSSTextAreaView", owner: self, options: nil)
    ...
    override func updateView() {
        super.updateView()
        placeholderLabel.setHSSStyle(style: config.placeholderStyle)
...
extension HSSTextAreaView: UITextViewDelegate {
